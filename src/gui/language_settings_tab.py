...
from i18n import LANGUAGES, get_current_language, set_language, translate as _
...
class LanguageSettingsTab(QWidget):
    ...
    def init_ui(self):
        ...
        language_label = QLabel(_("main.settings.language"))
        ...
        save_button = QPushButton(_("main.settings.save"))
        cancel_button = QPushButton(_("main.settings.cancel"))
        
        save_button.clicked.connect(self.save_settings)
        cancel_button.clicked.connect(self.reset_settings)
    ...
    def save_settings(self):
        ...
        if selected_language != self.current_language:
            ...
            QMessageBox.information(
                ...
                _("main.settings.language_changed").format(language=language_name)
            )
